document.addEventListener("DOMContentLoaded", () => {
  ...
  const marketAssets = [
    ...
    {
      id: "acao-empresa-PETR4",
      name: "Ação PETR4",
      type: "investimento-direto",
      value: 32,
      income: 7,
      description: "Uma ação de uma empresa petrolífera brasileira.",
      quantity: 1,
      sellValueMultiplier: 0.85,
    },

    {
      id: "acao-empresa-BBAS3",
      name: "Ação BBAS3",
      type: "investimento-direto",
      value: 25,
      income: 2.60,
      description: "Uma ação de uma das maiores e mais antigas instituições financeiras da América Latina.",
      quantity: 1,
      sellValueMultiplier: 0.85,
    },

    {
      id: "acao-empresa-BBSE3",
      name: "Ação BBSE3",
      type: "investimento-direto",
      value: 37,
      income: 2.27,
      description: "Uma ação de uma holding brasileira controlada pelo Banco do Brasil, que atua no subsetor de seguros, previdência privada e capitalização. ",
      quantity: 1,
      sellValueMultiplier: 0.85,
    },

    {
      id: "acao-empresa-ISAE4",
      name: "Ação ISAE4",
      type: "investimento-direto",
      value: 23,
      income: 2,
      description: "Uma ação de uma empresa do setor de utilidade pública e subsetor de energia elétrica.",
      quantity: 1,
      sellValueMultiplier: 0.85,
    },
    {
      id: "acao-empresa-CSMG3",
      name: "Ação CSMG3",
      type: "investimento-direto",
      value: 24,
      income: 2.77,
      description: "Uma ação de uma das principais empresas de saneamento do Brasil.",
      quantity: 1,
      sellValueMultiplier: 0.85,
    },
    {
      id: "acao-empresa-ITSA4",
      name: "Ação ITSA4",
      type: "investimento-direto",
      value: 11,
      income: 0.70,
      description: "Uma ação de uma das maiores holdings do Brasil e pertence ao setor financeiro de e subsetor de holdings diversificadas.",
      quantity: 1,
      sellValueMultiplier: 0.85,
    },
  ];
